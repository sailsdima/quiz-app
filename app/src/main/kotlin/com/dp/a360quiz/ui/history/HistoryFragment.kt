...
import com.dp.a360quiz.LocaleUtil
...
class HistoryFragment : Fragment(R.layout.fragment_history) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnLangEnglish.setOnClickListener {
            LocaleUtil.currentLanguage = "en"
            LocaleUtil.applyLocalizedContext(requireActivity().applicationContext, "en")
        }
        binding.btnLangUkrainian.setOnClickListener {
            LocaleUtil.currentLanguage = "ua"
            LocaleUtil.applyLocalizedContext(requireActivity().applicationContext, "ua")
        }
    }
